...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,node_577.r);
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                fixed4 finalRGBA = fixed4(finalColor * node_577.r,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
